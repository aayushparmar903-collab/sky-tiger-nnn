...
/** Fixed bottom-right WhatsApp chat button, visible on every scroll position. */
export default function WhatsAppFloat() {
  return (
    ...
    >
      <span className="glass pointer-events-none hidden translate-x-2 rounded-full px-4 py-2 text-xs font-medium text-white opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100 sm:block">
        Get your ID on WhatsApp
      </span>
      <span className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] shadow-[0_10px_35px_-8px_rgba(37,211,102,0.7)] transition-transform duration-300 group-hover:scale-110">
        {/* pulse ring */}
